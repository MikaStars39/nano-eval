...
LOG_DIR="/jpfs/qingyu/nano-eval/output/stage2_logs"
...
for ((i=0; i<$NUM_PODS; i++)); do
    ...
    (
        ...
        kubectl exec -n $NAMESPACE $POD -- bash -c "python /jpfs/qingyu/nano-eval/recipes/thinking_to_cot/stage2_run_shard.py \
